...
// // import { products, Product } from '../project';  // Import product data from project.ts
...
//           {products.map((product: { title: string; description: string; useCase: string; }, index: React.Key | null | undefined) => (
//             <div
//               key={index}
